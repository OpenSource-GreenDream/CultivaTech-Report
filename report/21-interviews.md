## 2.2. Entrevistas.
Para validar los problemas, necesidades y suposiciones del proceso Lean UX planteado en el Capítulo I, se diseñaron y ejecutaron entrevistas a profundidad cualitativas dirigidas a los tres segmentos objetivo identificados para CultivaTech.
...
#### Segmento 2: Proveedores de Insumos Agricolas
...
* **Segmento 1: Agricultores**
    ...
    * **Entrevista 1:**
        ...
        * **Timing:** 00:00 - 12:25
        * **Resumen:**
          Marcelino es un agricultor de Huánuco dedicado al cultivo de zanahorias. Representa a un segmento con baja alfabetización digital que utiliza teléfonos móviles básicos sin acceso a internet y enfrenta serios problemas de conectividad rural. Inicialmente muestra desconfianza frente a los sensores físicos por miedo a robos, daños al suelo o inversiones sin retorno. Sin embargo, valora positivamente el monitoreo agrícola automatizado si este le ayuda a reducir la incertidumbre del cambio climático, evitar el desgaste físico de recorrer sus hectáreas a su edad y mitigar el impacto de las heladas nocturnas.
    ...
    * **Entrevista 2:**
        ...
        * **Timing:** 12:30 - 23:53
        * **Resumen:**
          Joe enfatiza la necesidad de una plataforma con una interfaz extremadamente intuitiva que incluya un sistema de acompañamiento y tutoriales guiados. Debido a las limitaciones de infraestructura en su zona (cortes de luz y conectividad nula o intermitente), destaca que la asistencia debe ser accesible de forma offline o progresiva. Señala la importancia de implementar comunicación LoRaWAN para los dispositivos de monitoreo y exige herramientas visuales como *tooltips* persistentes y explicaciones paso a paso para operar con seguridad sin temor a cometer errores.

* **Segmento 2: Proveedores y Asesores Técnicos**
    ...
    * **Entrevista 1:**
        ...
        * **Timing:** 23:58 - 30:32
        * **Resumen:**
          Anita es una comercializadora mayorista de frutas y verduras que basa su negocio en la transparencia y la confianza con sus clientes. Para preservar la calidad de sus productos y proteger su reputación, requiere información meteorológica anticipada y precisa. Considera que contar con alertas climáticas en la plataforma le permitiría gestionar mejor la compra de cosechas y asegurar que la producción cumpla con los estándares exigidos por el mercado mayorista.

    * **Entrevista 2:**
        * **Nombres:** Karim
        * **Apellidos:** Castillo
        * **Edad:** 26 años
        * **Distrito:** Lima / Cañete
        * **Screenshot:**
          <!--ruta de la imagen: -->
        * **Video URL:** [https://tinyurl.com/bdh47w25](https://tinyurl.com/bdh47w25)
        * **Timing:** 30:37 - 36:30
        * **Resumen:**
          Karim es un asesor técnico y distribuidor de insumos agrícolas en Cañete. Al realizar sus recomendaciones de forma empírica y presencial, sufre por la falta de datos precisos sobre humedad y nutrientes en el suelo, lo que desencadena diagnósticos erróneos y reclamos. Manifiesta que disponer de datos del cultivo en tiempo real y recomendaciones automatizadas le permitiría optimizar sus asesorías, respaldar el uso de insumos con evidencia técnica y construir relaciones más duraderas con los agricultores.

* **Segmento 3: Clientes Finales y Compradores**
    ...
    * **Entrevista 1:**
        ...
        * **Timing:** 36:35 - 43:45
        * **Resumen:**
          Anjali prioriza la trazabilidad y la inocuidad alimentaria, buscando información clara sobre el uso de pesticidas y certificaciones agrícolas. Expresa frustración por la falta de transparencia en las etiquetas comerciales y la falta de medios para validar las prácticas de cultivo. Sugiere incorporar un espacio de consulta o validación comunitaria donde los consumidores puedan conocer la reputación de los productores y verificar la calidad de las cosechas.
    ...
    * **Entrevista 2:**
        ...
        * **Timing:** 43:50 - 50:56
        * **Resumen:**
          Luciana realiza compras semanales evaluando principalmente precio, apariencia y frescura. Aunque valora el consumo de productos locales y sostenibles, la decisión final se ve limitada si los precios son elevados o si la información en el empaque es ambigua. Propone la implementación de códigos QR en los productos o puntos de venta para acceder rápidamente a los detalles del cultivo y verificar el uso de insumos químicos desde el teléfono móvil.
    ...
    * **Entrevista 3:**
        ...
        * **Timing:** 51:01 - 58:04
        * **Resumen:**
          Albert es un comprador mayorista y comerciante en el Mercado Modelo de Lima. Enfrenta dificultades para verificar el historial agronómico y el impacto ambiental de los productos que adquiere. Afirma que acceder a un *dashboard* o código QR con datos sobre el manejo del suelo y la eficiencia del riego aumentaría su disposición a pagar un precio justo por cosechas de mayor calidad y le dará confianza para recomendar los productos a sus clientes.
